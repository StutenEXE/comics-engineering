  ...
  return (
    <div className="w-full flex flex-col gap-1.5">
      ...
      <Select value={selectedValue} onValueChange={handleValueChange}>
        <SelectTrigger className="min-w-50 bg-white/5 border border-white/10 rounded-md px-3 py-2 text-sm text-white/80 outline-none focus:border-indigo-500/70 focus:ring-1 focus:ring-indigo-500/30 transition-all cursor-pointer">
          <SelectValue
            placeholder={
