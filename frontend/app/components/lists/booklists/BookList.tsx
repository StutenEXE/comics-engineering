...
import { bookToSimpleBook, isSimpleBook, type Book, type SimpleBook } from "~/models/book";
...
export function BookList({ bookList, isLoading, error, className }: BookListProps) {
    ...
    const list: SimpleBook[] = !bookList || bookList.length === 0 ? [] 
        : isSimpleBook(bookList[0]) ? bookList as SimpleBook[]
