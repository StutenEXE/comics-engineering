export default {
    ...
    "book.form.linkedIssuesHint": "Recherchez par série d'issues et choisissez une ou plusieurs issues.",
    ...
    "contribution.update.error": "Erreur lors de la mise à jour de la contribution",
    "contribution.status.updated": "Statut de la contribution mis à jour",
    "contribution.status.updateerror": "Statut de la contribution n'a pas pu être mis à jour",
    // Contribution Bundle
    ...
    "cbundle.toast.updateError": "Erreur lors de la mise à jour du lot de contributions",
    ...
    "issue.coverDateExplanation": "Date écrite sur la couverture de l'issue, en général deux mois après la date de parution (tradition)",
    ...
    "serie.form.endDate.afterStart": "La date de fin ne peut pas être antérieur à la date de début",
    // User
    "user.id": "ID",
    ...
    "signup.password.gte8chars": "Votre mot de passe doit faire au moins 8 caractères",
